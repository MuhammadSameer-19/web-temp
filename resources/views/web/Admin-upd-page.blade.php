        ...
        <div class="text-white panel panel-primary">
          ...
          <div class="panel-body pt-5">
            <form action="connect.php" method="post">
              ...
              <label class="h4">Select Column To Update</label>
              <select class="form-select" >
                <option value="Pro_Name">Name</option>
                <option value="Pro_Detail">Detail</option>
                <option value="Pro_Category">Category</option>
                <option value="Pro_Price">Price</option>
                <option value="Pro_Image">Image</option>
            </select>
            </div>
            <div class="form-group">
                <label for="Pro_Name" class="h4 pt-4">New Value</label>
                <input
                  type="text"
                  class="form-control"
                  id="Pro_Name"
              ...
              <a href="./admin-panel" class="btn sub_btn btn-lg">Update</a>
